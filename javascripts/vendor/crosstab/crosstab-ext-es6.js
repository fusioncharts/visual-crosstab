...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ramda_src_map__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ramda_src_join__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ramda_src_join___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_ramda_src_join__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ramda_src_reduce__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ramda_src_values__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ramda_src_append__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ramda_src_append___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_ramda_src_append__);
...
class CrosstabExt {
    constructor (data, config) {
        this.data = __WEBPACK_IMPORTED_MODULE_5_immutable__["List"](data);
        this.eventList = __WEBPACK_IMPORTED_MODULE_5_immutable__["Map"]({
        ...
        this._columnKeyArr = __WEBPACK_IMPORTED_MODULE_5_immutable__["List"]([]);
        // Saving provided configuration into instance.
        this.measures = __WEBPACK_IMPORTED_MODULE_5_immutable__["List"](config.measures);
        this.dimensions = __WEBPACK_IMPORTED_MODULE_5_immutable__["List"](config.dimensions);
        this.chartConfig = __WEBPACK_IMPORTED_MODULE_5_immutable__["Map"](config.chartConfig);
        this.measureUnits = __WEBPACK_IMPORTED_MODULE_5_immutable__["List"](config.measureUnits);
        ...
        this.chartsAreSorted = __WEBPACK_IMPORTED_MODULE_5_immutable__["Map"]({
            bool: false,
            order: '',
            measure: ''
        });
    ...
    createGlobals () {
        ...
        this.globalData = __WEBPACK_IMPORTED_MODULE_5_immutable__["Map"](this.buildGlobalData());
    ...
    buildGlobalData () {
        ...
        function buildFields (obj, field) {
            obj[field] = __WEBPACK_IMPORTED_MODULE_5_immutable__["List"](ct.dataStore.getUniqueValues(field));
            return obj;
        }
    }
    ...
    createFilters () {
        ...
        return __WEBPACK_IMPORTED_MODULE_5_immutable__["Map"](filters);
    }
    ...
    makeGlobalArray () {
        ...
        return __WEBPACK_IMPORTED_MODULE_3_ramda_src_values___default()(__WEBPACK_IMPORTED_MODULE_0_ramda_src_map___default()(n => n, tempObj));
    }

    createDataCombos () {
        let ct = this,
            r = [],
            globalArray = __WEBPACK_IMPORTED_MODULE_5_immutable__["List"](ct.makeGlobalArray()),
            max = globalArray.size - 1;

        function recurse (arr, i) {
            globalArray.get(i).map((v, j) => {
                var a = __WEBPACK_IMPORTED_MODULE_4_ramda_src_append___default()(globalArray.get(i).get(j), arr);
                i === max ? r.push(a) : recurse(a, i + 1);
            });
        }
        recurse([], 0);
        return __WEBPACK_IMPORTED_MODULE_5_immutable__["List"](r);
    }
    ...
    getFilterHashMap () {
        ...
        dataCombos.forEach((data) => {
            let hash = __WEBPACK_IMPORTED_MODULE_1_ramda_src_join___default()('|', data);
            hashMap[hash] = __WEBPACK_IMPORTED_MODULE_2_ramda_src_reduce___default()(buildFilterArr, [], data);
            function buildFilterArr (a, b) {
                return __WEBPACK_IMPORTED_MODULE_4_ramda_src_append___default()(filters.get(b), a);
            }
        });
